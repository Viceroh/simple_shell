...
/**
* repeated_char - counts th xtwer repetition
*
...
/**
* first_char - finds index of  first x-ter
*
* @input: input string
* @i: index
* Return: 1 is returned on error and zero if there is none.
...
/**
* print_syntax_error - prints when syn err found
*
...
/**
* check_syntax_error - intermediate functiont. to
* find synt error
*
* @datash: data struct
* @input: input string
